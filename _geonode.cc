...
void Geometry::Initialize(Handle<Object> target)
{
    ...
    NODE_SET_PROTOTYPE_METHOD(t, "topologyPreserveSimplify", TopologyPreserveSimplify);
    // Unary predicates
...
GEONODE_GEOS_UNARY_TOPOLOGY_TOLERANCE(TopologyPreserveSimplify, topologyPreserveSimplify, GEOSTopologyPreserveSimplify);
